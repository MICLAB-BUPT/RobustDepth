...
def resnet_multiimage_input(num_layers, pretrained=False, num_input_images=1, n_img_channels=1):
    ...
    model = ResNetMultiImageInput(
        block_type, blocks, num_input_images=num_input_images, n_img_channels=n_img_channels)
...
class RadarResnetEncoder(nn.Module):
    ...
    def __init__(self, num_layers, pretrained, num_input_images=1, n_img_channels=1):
        super(RadarResnetEncoder, self).__init__()
        ...
        self.encoder = resnet_multiimage_input(
            num_layers, pretrained, num_input_images, n_img_channels)
