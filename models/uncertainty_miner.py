from models.uncertainty_block import UncertaintyBlock
import torch
...
class UncertaintyMiner(nn.Module):
    def __init__(self, pseudo_num, pseudo_input_dim):
        ...
        self.data_uncertainty_blocks = nn.ModuleList([
            ...
            UncertaintyBlock(256, pseudo_input_dim, pseudo_num),
        ])
        ...
        # self.downsample2x = nn.UpsamplingNearest2d(scale_factor=2)
    ...
    def forward(self, x, features):
        ...
        features[0] = F.interpolate(features[0], scale_factor=0.5, mode='nearest')
